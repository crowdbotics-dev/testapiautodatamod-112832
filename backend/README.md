...
## Project Structure
    ...
    ├── testapiautodatamod_112832  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112832`
...
2. Clone this repo and `cd testapiautodatamod_112832`
